...
from multiversx_sdk.network_providers.accounts import GuardianData
...
from multiversx_sdk.network_providers.http_resources import (
    account_from_api_response, block_from_response,
...
class ApiNetworkProvider(IBasicNetworkProvider):
    def __init__(self,
                 url: str,
    ...
    def get_account_storage(self, address: Address) -> AccountStorage:
        ...
        # will be forwarded to the proxy
        ...
    ...
    def get_account_storage_entry(self, address: Address, entry_key: str) -> AccountStorageEntry:
        ...
        # can be done using: https://devnet-api.multiversx.com/address/erd1qqqqqqqqqqqqqpgq076flgeualrdu5jyyj60snvrh7zu4qrg05vqez5jen/key/73756d
        # the key has to be hex encoded
        ...
    ...
    def send_transaction(self, transaction: ITransaction) -> bytes:
