...
DEFAULT_POLLING_INTERVAL_IN_MILLISECONDS = 6000
DEFAULT_TIMEOUT_IN_MILLISECONDS = 15 * DEFAULT_POLLING_INTERVAL_IN_MILLISECONDS
DEFALT_PATIENCE_IN_MILLISECONDS = 0
