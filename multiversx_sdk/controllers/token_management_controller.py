...
class TokenManagementController:
    ...
    def await_completed_issue_fungible(self, tx_hash: Union[str, bytes]) -> List[IssueFungibleOutcome]:
    ...
    def await_completed_issue_semi_fungible(self, tx_hash: Union[str, bytes]) -> List[IssueSemiFungibleOutcome]:
        transaction = self.network_provider.await_transaction_completed(tx_hash)
    ...
    def await_completed_issue_non_fungible(self, tx_hash: Union[str, bytes]) -> List[IssueNonFungibleOutcome]:
        transaction = self.network_provider.await_transaction_completed(tx_hash)
    ...
    def await_completed_register_meta_esdt(self, tx_hash: Union[str, bytes]) -> List[RegisterMetaEsdtOutcome]:
        transaction = self.network_provider.await_transaction_completed(tx_hash)
    ...
    def await_completed_register_and_set_all_roles(
            self, tx_hash: Union[str, bytes]) -> List[RegisterAndSetAllRolesOutcome]:
        transaction = self.network_provider.await_transaction_completed(tx_hash)
    ...
    def await_completed_set_burn_role_globally(self, tx_hash: Union[str, bytes]):
        transaction = self.network_provider.await_transaction_completed(tx_hash)
    ...
    def await_completed_unset_burn_role_globally(self, tx_hash: Union[str, bytes]):
        transaction = self.network_provider.await_transaction_completed(tx_hash)
    ...
    def await_completed_set_special_role_on_fungible_token(
            self, tx_hash: Union[str, bytes]) -> List[SetSpecialRoleOutcome]:
        transaction = self.network_provider.await_transaction_completed(tx_hash)
    ...
    def await_completed_create_nft(self, tx_hash: Union[str, bytes]) -> List[NFTCreateOutcome]:
        transaction = self.network_provider.await_transaction_completed(tx_hash)
    ...
    def await_completed_pause(self, tx_hash: Union[str, bytes]) -> List[PauseOutcome]:
        transaction = self.network_provider.await_transaction_completed(tx_hash)
    ...
    def await_completed_unpause(self, tx_hash: Union[str, bytes]) -> List[UnPauseOutcome]:
        transaction = self.network_provider.await_transaction_completed(tx_hash)
    ...
    def await_completed_freeze(self, tx_hash: Union[str, bytes]) -> List[FreezeOutcome]:
        transaction = self.network_provider.await_transaction_completed(tx_hash)
    ...
    def await_completed_unfreeze(self, tx_hash: Union[str, bytes]) -> List[UnFreezeOutcome]:
        transaction = self.network_provider.await_transaction_completed(tx_hash)
    ...
    def await_completed_wipe(self, tx_hash: Union[str, bytes]) -> List[WipeOutcome]:
        transaction = self.network_provider.await_transaction_completed(tx_hash)
    ...
    def await_completed_local_mint(self, tx_hash: Union[str, bytes]) -> List[MintOutcome]:
        transaction = self.network_provider.await_transaction_completed(tx_hash)
    ...
    def await_completed_local_burn(self, tx_hash: Union[str, bytes]) -> List[BurnOutcome]:
        transaction = self.network_provider.await_transaction_completed(tx_hash)
    ...
    def await_completed_update_attributes(self, tx_hash: Union[str, bytes]) -> List[UpdateAttributesOutcome]:
        transaction = self.network_provider.await_transaction_completed(tx_hash)
    ...
    def await_completed_add_quantity(self, tx_hash: Union[str, bytes]) -> List[AddQuantityOutcome]:
        transaction = self.network_provider.await_transaction_completed(tx_hash)
    ...
    def await_completed_burn_quantity(self, tx_hash: Union[str, bytes]) -> List[BurnQuantityOutcome]:
        transaction = self.network_provider.await_transaction_completed(tx_hash)
