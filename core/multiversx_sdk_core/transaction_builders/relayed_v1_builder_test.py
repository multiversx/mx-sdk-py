...
class TestRelayedV1Builder:
    ...
    def test_compute_relayedV1_with_usernames(self):
        ...
        # version is set to 1 to match the test in sdk-js-core
        inner_tx.version = 1
        inner_tx.signature = self.carol.secret_key.sign(transaction_computer.compute_bytes_for_signing(inner_tx))
        ...
        relayed_tx.signature = self.frank.secret_key.sign(transaction_computer.compute_bytes_for_signing(relayed_tx))
